...
def create_test_node2():
    ...
    try:
        ...
        if login_response.status_code == 200:
            ...
            test_node_data = {
                "node_name": "测试节点2",
                "cron_schedule": "15 9,13,19 * * *",
                "min_sleep_minutes": 8,
                "max_sleep_minutes": 15,
                "clusters": 2,
                "search_delay_min": "45s",
                "search_delay_max": "3min"
            }
            ...
            if create_response.status_code == 200:
                ...
                if nodes_response.status_code == 200:
                    ...
                    for i, node in enumerate(nodes):
                        print(f"节点 {i+1}: ID={node['id']}, 名称={node['node_name']}")
